...
int main()
{
    ...
    double pctApprove = numApprove * numSurveyed;   // removed the 100.0 *
    double pctDisapprove = numDisapprove * numSurveyed; // multiplied both variables instead of dividing
    ...
    if (numApprove < numDisapprove)     // changed the > to a <
