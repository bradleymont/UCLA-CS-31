...
int main()
{
    ...
    cout << "How many people were surveyed? "  // removed semicolon
    cin >> numSurveyed;
    ...
    cin >> NumDisapprove;   // incorrectly typed NumDisapprove instead of numDisapprove
    ...
    if (numberApprove > numDisapprove)     // incorrectly typed variable numApprove as numberApprove
